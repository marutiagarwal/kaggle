...
from featureProcessing import prune_train_features, encode_features_for_training
...
if __name__ == '__main__':
	...
	df_pruned = prune_train_features(df)
	X, y, encoder, scaler = encode_features_for_training(df_pruned,labels)
